...
public abstract class Problem {
	 ...
	 *         dimension.
	 */
	public abstract double getLowerBound(int dimensions);
	...
	public abstract double getUpperBound(int dimensions);
	...
	public abstract boolean isFitnessBetterThan(double currentSolution, double bestSolutionFitness);
